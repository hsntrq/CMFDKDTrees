          ...
          <div className="col" style={{ margin: "0 10%" }}>
            <form onSubmit={this.postData}>
              ...
              <div className="drop">
                ...
                <input id="files" name="imageInput" type="file" required />
              </div>
            </div>
              </div>
              <label>Alpha:</label>
              <input className="form-control" type="text" name="alpha"/>
              <label style={{ margin: "5px 0px" }}>BlockSize:</label>
              <input className="form-control" type="text"  name="blockSize"/>
