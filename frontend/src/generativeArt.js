...
<br/>References: https://towardsdatascience.com/getting-started-with-generative-art-in-r-3bc50067d34b
                ...
                <div className="row" style={{margin: "30px 0px"}}>
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_1.jpeg" alt="Card Image"/></a>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_2.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_4.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_6.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/ellipse.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        ...
                        </div><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_9.jpeg" alt="Card Image"/>
                    </div>
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_10.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_8.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card border-0"><a href="#"><img className="card-img-top scale-on-hover" src="/static/assets/img/Generative_Art_7.jpeg" alt="Card Image"/></a>
                            <div className="card-body">
                                <h6></h6>
                            </div>
                        </div>
