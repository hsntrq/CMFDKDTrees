                    ...
                    <div key={index} className="col-sm-12 col-lg-6">
                      <div className="card border-0">
                          <div className="card-body">
                              <h6><a href="#">Picture {index+1}</a></h6>
                              <p className="text-muted card-text">For this image, alpha = 10, blocksize = 9, tm = 0.001</p>
                              <div className="row">
                                  <div className="col-6"><a href={item.imageInput}><img className="card-img-top scale-on-hover" src={item.imageInput} alt="Card Image"/></a></div>
                                  <div className="col-6"><a href={item.imageOutput}><img className="card-img-top scale-on-hover" src={item.imageOutput} alt="Card Image"/></a></div>
                              </div>
                          </div>
                      </div>
                  </div>
